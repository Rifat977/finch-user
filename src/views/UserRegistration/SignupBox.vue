            ...
            <form @submit.prevent="registerUser">
                ...
                <div class="consent-section">
                    <div class="checkbox-wrapper">
                        ...
                        <label for="terms">
                            I accept the
                            <router-link to="/" style="text-decoration: none; color: #6d9def">Terms & Conditions</router-link> and
                ...
                <div class="form-footer">
                    <p>Already have an account? <router-link to="/login" style="text-decoration: none; color: #6d9def">Log In</router-link></p>
                </div>
            </form>
        </div>
    </section>
        ...
        async registerUser() {
            ...
            try {
                const response = await axios.post(
                    "https://gorana.onrender.com/users/register/",
                    {
...
.signup-box input,
.signup-box button {
    font-size: 1.2rem; /* Adjust font size for labels, inputs, and buttons */
}
